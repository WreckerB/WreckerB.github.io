import{d as Z,r as _,b_ as ct,h as b,c8 as bt,c9 as K,ca as ft,A as pt,D as Re,ag as ut,j as q,q as vt,al as ht,N as gt,ak as mt,ah as xt,cb as yt,b as n,e as i,g as C,x as A,aq as wt,u as St,k as Te,bA as ee,i as te,z as Ct,t as H,w as Rt,n as Tt,ax as ve,bY as he,cc as zt,$ as G,v as ae,X as j,c3 as Y,Z as $t,a7 as Pt,cd as _t,bZ as Wt}from"./index-03963baa.js";import{A as At}from"./Add-423678ad.js";import{u as ge}from"./use-compitable-2c370347.js";import{u as Lt}from"./use-merged-state-224a29bb.js";import{c as Bt,a as me,o as Et}from"./cssr-8cbe0d73.js";const kt=me(".v-x-scroll",{overflow:"auto",scrollbarWidth:"none"},[me("&::-webkit-scrollbar",{width:0,height:0})]),jt=Z({name:"XScroll",props:{disabled:Boolean,onScroll:Function},setup(){const e=_(null);function r(l){!(l.currentTarget.offsetWidth<l.currentTarget.scrollWidth)||l.deltaY===0||(l.currentTarget.scrollLeft+=l.deltaY+l.deltaX,l.preventDefault())}const d=ct();return kt.mount({id:"vueuc/x-scroll",head:!0,anchorMetaName:Bt,ssr:d}),Object.assign({selfRef:e,handleWheel:r},{scrollTo(...l){var h;(h=e.value)===null||h===void 0||h.scrollTo(...l)}})},render(){return b("div",{ref:"selfRef",onScroll:this.onScroll,onWheel:this.disabled?void 0:this.handleWheel,class:"v-x-scroll"},this.$slots)}});var It=/\s/;function Ot(e){for(var r=e.length;r--&&It.test(e.charAt(r)););return r}var Ft=/^\s+/;function Ht(e){return e&&e.slice(0,Ot(e)+1).replace(Ft,"")}var xe=0/0,Dt=/^[-+]0x[0-9a-f]+$/i,Mt=/^0b[01]+$/i,Nt=/^0o[0-7]+$/i,Vt=parseInt;function ye(e){if(typeof e=="number")return e;if(bt(e))return xe;if(K(e)){var r=typeof e.valueOf=="function"?e.valueOf():e;e=K(r)?r+"":r}if(typeof e!="string")return e===0?e:+e;e=Ht(e);var d=Mt.test(e);return d||Nt.test(e)?Vt(e.slice(2),d?2:8):Dt.test(e)?xe:+e}var Xt=function(){return ft.Date.now()};const re=Xt;var Ut="Expected a function",Gt=Math.max,Yt=Math.min;function qt(e,r,d){var u,l,h,v,f,g,m=0,y=!1,w=!1,x=!0;if(typeof e!="function")throw new TypeError(Ut);r=ye(r)||0,K(d)&&(y=!!d.leading,w="maxWait"in d,h=w?Gt(ye(d.maxWait)||0,r):h,x="trailing"in d?!!d.trailing:x);function S(c){var z=u,I=l;return u=l=void 0,m=c,v=e.apply(I,z),v}function R(c){return m=c,f=setTimeout(L,r),y?S(c):v}function W(c){var z=c-g,I=c-m,F=r-z;return w?Yt(F,h-I):F}function $(c){var z=c-g,I=c-m;return g===void 0||z>=r||z<0||w&&I>=h}function L(){var c=re();if($(c))return T(c);f=setTimeout(L,W(c))}function T(c){return f=void 0,x&&u?S(c):(u=l=void 0,v)}function B(){f!==void 0&&clearTimeout(f),m=0,u=g=l=f=void 0}function k(){return f===void 0?v:T(re())}function p(){var c=re(),z=$(c);if(u=arguments,l=this,g=c,z){if(f===void 0)return R(g);if(w)return clearTimeout(f),f=setTimeout(L,r),S(g)}return f===void 0&&(f=setTimeout(L,r)),v}return p.cancel=B,p.flush=k,p}var Kt="Expected a function";function ne(e,r,d){var u=!0,l=!0;if(typeof e!="function")throw new TypeError(Kt);return K(d)&&(u="leading"in d?!!d.leading:u,l="trailing"in d?!!d.trailing:l),qt(e,r,{leading:u,maxWait:r,trailing:l})}const se=pt("n-tabs"),ze={tab:[String,Number,Object,Function],name:{type:[String,Number],required:!0},disabled:Boolean,displayDirective:{type:String,default:"if"},closable:{type:Boolean,default:void 0},tabProps:Object,label:[String,Number,Object,Function]},oa=Z({__TAB_PANE__:!0,name:"TabPane",alias:["TabPanel"],props:ze,setup(e){const r=Re(se,null);return r||ut("tab-pane","`n-tab-pane` must be placed inside `n-tabs`."),{style:r.paneStyleRef,class:r.paneClassRef,mergedClsPrefix:r.mergedClsPrefixRef}},render(){return b("div",{class:[`${this.mergedClsPrefix}-tab-pane`,this.class],style:this.style},this.$slots)}}),Zt=Object.assign({internalLeftPadded:Boolean,internalAddable:Boolean,internalCreatedByPane:Boolean},yt(ze,["displayDirective"])),ie=Z({__TAB__:!0,inheritAttrs:!1,name:"Tab",props:Zt,setup(e){const{mergedClsPrefixRef:r,valueRef:d,typeRef:u,closableRef:l,tabStyleRef:h,tabChangeIdRef:v,onBeforeLeaveRef:f,triggerRef:g,handleAdd:m,activateTab:y,handleClose:w}=Re(se);return{trigger:g,mergedClosable:q(()=>{if(e.internalAddable)return!1;const{closable:x}=e;return x===void 0?l.value:x}),style:h,clsPrefix:r,value:d,type:u,handleClose(x){x.stopPropagation(),!e.disabled&&w(e.name)},activateTab(){if(e.disabled)return;if(e.internalAddable){m();return}const{name:x}=e,S=++v.id;if(x!==d.value){const{value:R}=f;R?Promise.resolve(R(e.name,d.value)).then(W=>{W&&v.id===S&&y(x)}):y(x)}}}},render(){const{internalAddable:e,clsPrefix:r,name:d,disabled:u,label:l,tab:h,value:v,mergedClosable:f,style:g,trigger:m,$slots:{default:y}}=this,w=l??h;return b("div",{class:`${r}-tabs-tab-wrapper`},this.internalLeftPadded?b("div",{class:`${r}-tabs-tab-pad`}):null,b("div",Object.assign({key:d,"data-name":d,"data-disabled":u?!0:void 0},vt({class:[`${r}-tabs-tab`,v===d&&`${r}-tabs-tab--active`,u&&`${r}-tabs-tab--disabled`,f&&`${r}-tabs-tab--closable`,e&&`${r}-tabs-tab--addable`],onClick:m==="click"?this.activateTab:void 0,onMouseenter:m==="hover"?this.activateTab:void 0,style:e?void 0:g},this.internalCreatedByPane?this.tabProps||{}:this.$attrs)),b("span",{class:`${r}-tabs-tab__label`},e?b(ht,null,b("div",{class:`${r}-tabs-tab__height-placeholder`}," "),b(gt,{clsPrefix:r},{default:()=>b(At,null)})):y?y():typeof w=="object"?w:mt(w??d)),f&&this.type==="card"?b(xt,{clsPrefix:r,class:`${r}-tabs-tab__close`,onClick:this.handleClose,disabled:u}):null))}}),Jt=n("tabs",`
