...
`,[R("color-transition",{transition:"color .3s var(--n-bezier)"}),R("depth",{color:"var(--n-color)"},[T("svg",{opacity:"var(--n-opacity)",transition:"opacity .3s var(--n-bezier)"})]),T("svg",{height:"1em",width:"1em"})]),oo=Object.assign(Object.assign({},U.props),{depth:[String,Number],size:[Number,String],color:String,component:Object}),no=N({_n_icon__:!0,name:"Icon",inheritAttrs:!1,props:oo,setup(e){const{mergedClsPrefixRef:n,inlineThemeDisabled:i}=ae(e),t=U("Icon","-icon",eo,Ae,e,n),r=w(()=>{const{depth:l}=e,{common:{cubicBezierEaseInOut:u},self:d}=t.value;if(l!==void 0){const{color:y,[`opacity${l}Depth`]:h}=d;return{"--n-bezier":u,"--n-color":y,"--n-opacity":h}}return{"--n-bezier":u,"--n-color":"","--n-opacity":""}}),o=i?me("icon",w(()=>`${e.depth||"d"}`),r,e):void 0;return{mergedClsPrefix:n,mergedStyle:w(()=>{const{size:l,color:u}=e;return{fontSize:Ve(l),color:u}}),cssVars:i?void 0:r,themeClass:o==null?void 0:o.themeClass,onRender:o==null?void 0:o.onRender}},render(){var e;const{$parent:n,depth:i,mergedClsPrefix:t,component:r,onRender:o,themeClass:l}=this;return!((e=n==null?void 0:n.$options)===null||e===void 0)&&e._n_icon__&&be("icon","don't wrap `n-icon` inside `n-icon`"),o==null||o(),s("i",le(this.$attrs,{role:"img",class:[`${t}-icon`,l,{[`${t}-icon--depth`]:i,[`${t}-icon--color-transition`]:i!==void 0}],style:[this.cssVars,this.mergedStyle]}),r?s(r):this.$slots)}}),ue=ce("n-dropdown-menu"),Q=ce("n-dropdown"),he=ce("n-dropdown-option");function ie(e,n){return e.type==="submenu"||e.type===void 0&&e[n]!==void 0}function to(e){return e.type==="group"}function ge(e){return e.type==="divider"}function ro(e){return e.type==="render"}const xe=N({name:"DropdownOption",props:{clsPrefix:{type:String,required:!0},tmNode:{type:Object,required:!0},parentKey:{type:[String,Number],default:null},placement:{type:String,default:"right-start"},props:Object,scrollable:Boolean},setup(e){const n=M(Q),{hoverKeyRef:i,keyboardKeyRef:t,lastToggledSubmenuKeyRef:r,pendingKeyPathRef:o,activeKeyPathRef:l,animatedRef:u,mergedShowRef:d,renderLabelRef:y,renderIconRef:h,labelFieldRef:g,childrenFieldRef:S,renderOptionRef:_,nodePropsRef:I,menuPropsRef:B}=n,x=M(he,null),K=M(ue),q=M(we),Y=w(()=>e.tmNode.rawNode),V=w(()=>{const{value:c}=S;return ie(e.tmNode.rawNode,c)}),ee=w(()=>{const{disabled:c}=e.tmNode;return c}),oe=w(()=>{if(!V.value)return!1;const{key:c,disabled:b}=e.tmNode;if(b)return!1;const{value:C}=i,{value:D}=t,{value:te}=r,{value:A}=o;return C!==null?A.includes(c):D!==null?A.includes(c)&&A[A.length-1]!==c:te!==null?A.includes(c):!1}),ne=w(()=>t.value===null&&!u.value),G=Ze(oe,300,ne),L=w(()=>!!(x!=null&&x.enteringSubmenuRef.value)),E=j(!1);H(he,{enteringSubmenuRef:E});function $(){E.value=!0}function a(){E.value=!1}function m(){const{parentKey:c,tmNode:b}=e;b.disabled||d.value&&(r.value=c,t.value=null,i.value=b.key)}function f(){const{tmNode:c}=e;c.disabled||d.value&&i.value!==c.key&&m()}function p(c){if(e.tmNode.disabled||!d.value)return;const{relatedTarget:b}=c;b&&!fe({target:b},"dropdownOption")&&!fe({target:b},"scrollbarRail")&&(i.value=null)}function P(){const{value:c}=V,{tmNode:b}=e;d.value&&!c&&!b.disabled&&(n.doSelect(b.key,b.rawNode),n.doUpdateShow(!1))}return{labelField:g,renderLabel:y,renderIcon:h,siblingHasIcon:K.showIconRef,siblingHasSubmenu:K.hasSubmenuRef,menuProps:B,popoverBody:q,animated:u,mergedShowSubmenu:w(()=>G.value&&!L.value),rawNode:Y,hasSubmenu:V,pending:Z(()=>{const{value:c}=o,{key:b}=e.tmNode;return c.includes(b)}),childActive:Z(()=>{const{value:c}=l,{key:b}=e.tmNode,C=c.findIndex(D=>b===D);return C===-1?!1:C<c.length-1}),active:Z(()=>{const{value:c}=l,{key:b}=e.tmNode,C=c.findIndex(D=>b===D);return C===-1?!1:C===c.length-1}),mergedDisabled:ee,renderOption:_,nodeProps:I,handleClick:P,handleMouseMove:f,handleMouseEnter:m,handleMouseLeave:p,handleSubmenuBeforeEnter:$,handleSubmenuAfterEnter:a}},render(){var e,n;const{animated:i,rawNode:t,mergedShowSubmenu:r,clsPrefix:o,siblingHasIcon:l,siblingHasSubmenu:u,renderLabel:d,renderIcon:y,renderOption:h,nodeProps:g,props:S,scrollable:_}=this;let I=null;if(r){const q=(e=this.menuProps)===null||e===void 0?void 0:e.call(this,t,t.children);I=s(Se,Object.assign({},q,{clsPrefix:o,scrollable:this.scrollable,tmNodes:this.tmNode.children,parentKey:this.tmNode.key}))}const B={class:[`${o}-dropdown-option-body`,this.pending&&`${o}-dropdown-option-body--pending`,this.active&&`${o}-dropdown-option-body--active`,this.childActive&&`${o}-dropdown-option-body--child-active`,this.mergedDisabled&&`${o}-dropdown-option-body--disabled`],onMousemove:this.handleMouseMove,onMouseenter:this.handleMouseEnter,onMouseleave:this.handleMouseLeave,onClick:this.handleClick},x=g==null?void 0:g(t),K=s("div",Object.assign({class:[`${o}-dropdown-option`,x==null?void 0:x.class],"data-dropdown-option":!0},x),s("div",le(B,S),[s("div",{class:[`${o}-dropdown-option-body__prefix`,l&&`${o}-dropdown-option-body__prefix--show-icon`]},[y?y(t):J(t.icon)]),s("div",{"data-dropdown-option":!0,class:`${o}-dropdown-option-body__label`},d?d(t):J((n=t[this.labelField])!==null&&n!==void 0?n:t.title)),s("div",{"data-dropdown-option":!0,class:[`${o}-dropdown-option-body__suffix`,u&&`${o}-dropdown-option-body__suffix--has-submenu`]},this.hasSubmenu?s(no,null,{default:()=>s(Qe,null)}):null)]),this.hasSubmenu?s(_e,null,{default:()=>[s(Ce,null,{default:()=>s("div",{class:`${o}-dropdown-offset-container`},s(Oe,{show:this.mergedShowSubmenu,placement:this.placement,to:_&&this.popoverBody||void 0,teleportDisabled:!_},{default:()=>s("div",{class:`${o}-dropdown-menu-wrapper`},i?s(Fe,{onBeforeEnter:this.handleSubmenuBeforeEnter,onAfterEnter:this.handleSubmenuAfterEnter,name:"fade-in-scale-up-transition",appear:!0},{default:()=>I}):I)}))})]}):null);return h?h({node:K,option:t}):K}}),io=N({name:"DropdownGroupHeader",props:{clsPrefix:{type:String,required:!0},tmNode:{type:Object,required:!0}},setup(){const{showIconRef:e,hasSubmenuRef:n}=M(ue),{renderLabelRef:i,labelFieldRef:t,nodePropsRef:r,renderOptionRef:o}=M(Q);return{labelField:t,showIcon:e,hasSubmenu:n,renderLabel:i,nodeProps:r,renderOption:o}},render(){var e;const{clsPrefix:n,hasSubmenu:i,showIcon:t,nodeProps:r,renderLabel:o,renderOption:l}=this,{rawNode:u}=this.tmNode,d=s("div",Object.assign({class:`${n}-dropdown-option`},r==null?void 0:r(u)),s("div",{class:`${n}-dropdown-option-body ${n}-dropdown-option-body--group`},s("div",{"data-dropdown-option":!0,class:[`${n}-dropdown-option-body__prefix`,t&&`${n}-dropdown-option-body__prefix--show-icon`]},J(u.icon)),s("div",{class:`${n}-dropdown-option-body__label`,"data-dropdown-option":!0},o?o(u):J((e=u.title)!==null&&e!==void 0?e:u[this.labelField])),s("div",{class:[`${n}-dropdown-option-body__suffix`,i&&`${n}-dropdown-option-body__suffix--has-submenu`],"data-dropdown-option":!0})));return l?l({node:d,option:u}):d}}),so=N({name:"NDropdownGroup",props:{clsPrefix:{type:String,required:!0},tmNode:{type:Object,required:!0},parentKey:{type:[String,Number],default:null}},render(){const{tmNode:e,parentKey:n,clsPrefix:i}=this,{children:t}=e;return s(Me,null,s(io,{clsPrefix:i,tmNode:e,key:e.key}),t==null?void 0:t.map(r=>{const{rawNode:o}=r;return o.show===!1?null:ge(o)?s(ye,{clsPrefix:i,key:r.key}):r.isGroup?(be("dropdown","`group` node is not allowed to be put in `group` node."),null):s(xe,{clsPrefix:i,tmNode:r,parentKey:n,key:r.key})}))}}),ao=N({name:"DropdownRenderOption",props:{tmNode:{type:Object,required:!0}},render(){const{rawNode:{render:e,props:n}}=this.tmNode;return s("div",n,[e==null?void 0:e()])}}),Se=N({name:"DropdownMenu",props:{scrollable:Boolean,showArrow:Boolean,arrowStyle:[String,Object],clsPrefix:{type:String,required:!0},tmNodes:{type:Array,default:()=>[]},parentKey:{type:[String,Number],default:null}},setup(e){const{renderIconRef:n,childrenFieldRef:i}=M(Q);H(ue,{showIconRef:w(()=>{const r=n.value;return e.tmNodes.some(o=>{var l;if(o.isGroup)return(l=o.children)===null||l===void 0?void 0:l.some(({rawNode:d})=>r?r(d):d.icon);const{rawNode:u}=o;return r?r(u):u.icon})}),hasSubmenuRef:w(()=>{const{value:r}=i;return e.tmNodes.some(o=>{var l;if(o.isGroup)return(l=o.children)===null||l===void 0?void 0:l.some(({rawNode:d})=>ie(d,r));const{rawNode:u}=o;return ie(u,r)})})});const t=j(null);return H(Be,null),H(Le,null),H(we,t),{bodyRef:t}},render(){const{parentKey:e,clsPrefix:n,scrollable:i}=this,t=this.tmNodes.map(r=>{const{rawNode:o}=r;return o.show===!1?null:ro(o)?s(ao,{tmNode:r,key:r.key}):ge(o)?s(ye,{clsPrefix:n,key:r.key}):to(o)?s(so,{clsPrefix:n,tmNode:r,parentKey:e,key:r.key}):s(xe,{clsPrefix:n,tmNode:r,parentKey:e,key:r.key,props:o.props,scrollable:i})});return s("div",{class:[`${n}-dropdown-menu`,i&&`${n}-dropdown-menu--scrollable`],ref:"bodyRef"},i?s(Ee,{contentClass:`${n}-dropdown-menu__content`},{default:()=>t}):t,this.showArrow?Ie({clsPrefix:n,arrowStyle:this.arrowStyle}):null)}}),lo=k("dropdown-menu",`
